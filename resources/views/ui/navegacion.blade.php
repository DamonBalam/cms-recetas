...
<a href="{{ route('perfiles.edit', ['perfil' => auth()->user()->id]) }}"
    class="btn btn-outline-dark mr-2 text-uppercase font-weight-bold">
...
<a href="{{ route('perfiles.show', ['perfil' => auth()->user()->id]) }}"
    class="btn btn-outline-success mr-2 text-uppercase font-weight-bold  align-content-center">
    <svg class="icono" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
